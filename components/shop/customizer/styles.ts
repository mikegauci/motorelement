...
const styles: Record<string, string> = {
  ...
  tweakModelRow: 'flex flex-wrap gap-1 mb-2',
  tweakModelBtn: 'h-8 px-3 flex items-center justify-center border border-border bg-carbon text-white text-xs font-sub font-bold uppercase tracking-widest cursor-pointer transition-all hover:border-white/30 hover:bg-white/5 disabled:opacity-50 disabled:cursor-not-allowed',
  tweakModelBtnActive: '!border-ignition bg-ignition/10',
